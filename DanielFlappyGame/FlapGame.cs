...
namespace DanielFlappyGame
{
    ...
    {       
        ...
        private TimeSpan delta = new TimeSpan(0, 0, 0, 0, 500);
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            flapModel = new Model("Resources/crow_for_project.obj", "Resources/stam_tmuna.png");
            Init();
        ...
        protected override void Update()
        {
            ...
            if(curDelta.TotalMilliseconds > delta.TotalMilliseconds)
            {
   ...
   //          gameCam.Rotation.Y += rot;
        ...
        protected override void Render()
        {
           ...
           Cube.DrawCube(Screen, Matrix4.CreateTranslation(flappyflappy.Position), view, projection);
        }
